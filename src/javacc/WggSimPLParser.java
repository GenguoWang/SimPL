...
public class WggSimPLParser/*@bgen(jjtree)*/implements WggSimPLParserTreeConstants, WggSimPLParserConstants {/*@bgen(jjtree)*/
  protected JJTWggSimPLParserState jjtree = new JJTWggSimPLParserState();public SimpleNode getTreeRoot()
 {
  ...
  final public void syntax_Analysis() throws ParseException {
 ...
 /*@bgen(jjtree) #Sequence(> 1) */
  ...
  final public void SingleExpression() throws ParseException {
 /*@bgen(jjtree) #ConditionalNode( false) */
  SimpleNode jjtn000 = (SimpleNode)SimpleNode.jjtCreate(this, JJTCONDITIONALNODE);
  boolean jjtc000 = true;
  jjtree.openNodeScope(jjtn000);
 ...
 /*@bgen(jjtree) #ListExpression(> 1) */
  ...
  final public void AddOrExpression() throws ParseException {
 /*@bgen(jjtree) #AddOrExpression(> 1) */
  ...
  final public void AddOr_Op() throws ParseException {
 ...
 /*@bgen(jjtree) #CondExpression(> 1) */
  ...
  final public void Cond_Op() throws ParseException {
 /*@bgen(jjtree) Cond_Op */
 ...
 /*@bgen(jjtree) #AddSubExpression(> 1) */
  ...
  final public void AddSub_Op() throws ParseException {
 /*@bgen(jjtree) AddSub_Op */
  ...
  final public void MulDivExpression() throws ParseException {
 /*@bgen(jjtree) #MulDivExpression(> 1) */
  ...
  final public void MulDiv_Op() throws ParseException {
 /*@bgen(jjtree) MulDiv_Op */
  ...
  final public void UopExpression() throws ParseException {
 /*@bgen(jjtree) #UopExpression(> 1) */
  ...
  final public void Uop() throws ParseException {
 /*@bgen(jjtree) Uop */
 ...
 /*@bgen(jjtree) #ConditionalNode( false) */
  ...
  final public void PrintExp() throws ParseException {
 ...
 /*@bgen(jjtree) #ConditionalNode( false) */
  ...
  final public void VInt() throws ParseException {
 /*@bgen(jjtree) VInt */
  ...
  final public void VBool() throws ParseException {
 /*@bgen(jjtree) VBool */
  ...
  final public void VNil() throws ParseException {
 /*@bgen(jjtree) VNil */
  ...
  final public void VNop() throws ParseException {
 /*@bgen(jjtree) VNop */
  ...
  final public void PairExp() throws ParseException {
 /*@bgen(jjtree) PairExp */
  ...
  final public void AppExp() throws ParseException {
 /*@bgen(jjtree) AppExp */
  ...
  final public void LetExp() throws ParseException {
 /*@bgen(jjtree) LetExp */
 ...
 /*@bgen(jjtree) IfExp */
  ...
  final public void WhileExp() throws ParseException {
 /*@bgen(jjtree) WhileExp */
  ...
  final public void BraExp() throws ParseException {
 /*@bgen(jjtree) BraExp */
